...
public class Dial
{
    ...
    static public void main(String[] args) throws IllegalStateException, IOException, AuthenticationFailedException, TimeoutException
    {    	
     ...
     */
    static private void syncDial() throws IllegalStateException, IOException, AuthenticationFailedException, TimeoutException
    {
        try
        {  
        	
    		InitAsteriskSettings asteriskSettings = new InitAsteriskSettings();    		
           ...
           // PBX pbx = PBXFactory.getActivePBX();
            ...
            Trunk trunk = pbx.buildTrunk("from-internal");

            // We are going to dial from extension 100
            EndPoint from = pbx.buildEndPoint(TechType.SIP, "SIP/3002");
            // The caller ID to show on extension 100.
            CallerID fromCallerID = pbx.buildCallerID("3002", "My Phone");

            // The caller ID to display on the called parties phone
            CallerID toCallerID = pbx.buildCallerID("3002", "Asterisk Java is calling");
            // The party we are going to call.
            EndPoint to = pbx.buildEndPoint(TechType.SIP, trunk, "09788798465");
    ...
    {
    	PBXFactory.init(new InitAsteriskSettings());
        PBX pbx = PBXFactory.getActivePBX();
